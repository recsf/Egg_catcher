...
catcher_width = 100
catcher_height = 100
catcher_startx = canvasWidth / 2 - catcher_width / 2
catcher_starty = catcher_height - catcher_height
...
lives_remaining = 3
lives_text = c.create_text(canvasWidth-10, 10, anchor="ne", font=game_font, fill="darkblue",
